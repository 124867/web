...
const MainIndexTraditional: FunctionComponent = () => {
  ...
  const onFrameContainer23Click = useCallback(() => {
    navigate("/main-index-simplified");
  }, [navigate]);

  return (
    <div className="relative bg-white w-full h-[3721px] overflow-hidden text-left text-17xl text-black font-inter">
      <div className="absolute top-[3537px] left-[0px] w-[1468px] h-[184px]">
      ...
      <div className="absolute top-[290px] left-[0px] w-[1469px] h-[3201px] text-base">
        <div className="absolute top-[1571px] left-[36px] shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] w-[1395.28px] flex flex-col items-center justify-center text-13xl">
          <div className="relative w-[1395.28px] h-[1630px]">
            <div className="absolute top-[158px] left-[0.28px] w-[634px] h-[714px]">
              ...
              <div className="absolute top-[678px] left-[11px] rounded-xl bg-mediumseagreen box-border w-14 h-9 flex flex-col py-2 px-0 items-center justify-start text-base text-white border-[1px] border-solid border-black">
            ...
            <div className="absolute top-[158px] left-[761.28px] w-[633px] h-[714px] text-base">
              ...
              <div className="absolute top-[678px] left-[10px] rounded-xl bg-mediumseagreen box-border w-14 h-9 flex flex-col py-2 px-[13px] items-start justify-start text-white border-[1px] border-solid border-black">
                <div className="relative">16A</div>
              </div>
                ...
                <div className="absolute top-[0px] left-[72px] w-[275px] h-9">
                  ...
                  <div className="absolute top-[0px] left-[70px] w-[205px] h-9">
                    ...
                    <div className="absolute top-[0px] left-[75px] w-[130px] h-9">
                      ...
                      <div className="absolute top-[0px] left-[74px] rounded-xl bg-mediumseagreen box-border w-14 h-9 flex flex-col py-2 px-0 items-center justify-start border-[1px] border-solid border-black">
                        <div className="relative">52</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="absolute top-[916px] left-[2.28px] w-[633px] h-[714px] text-base text-white">
              ...
              <div className="absolute top-[678px] left-[158px] rounded-xl bg-mediumseagreen box-border w-14 h-9 flex flex-col py-2 px-0 items-center justify-start border-[1px] border-solid border-black">
                <div className="relative">12</div>
              </div>
              <div className="absolute top-[678px] left-[84px] rounded-xl bg-mediumseagreen box-border w-14 h-9 flex flex-col py-2 px-[18px] items-start justify-start border-[1px] border-solid border-black">
                <div className="relative">1A</div>
              </div>
              ...
              <div className="absolute top-[678px] left-[10px] rounded-xl bg-mediumseagreen box-border w-14 h-9 flex flex-col py-2 px-0 items-center justify-start border-[1px] border-solid border-black">
                <div className="relative">1</div>
              </div>
              <img
                className="absolute top-[0px] left-[0px] rounded-xl w-[633px] h-[572px] object-cover"
            ...
            <div className="absolute top-[916px] left-[761.28px] w-[634px] h-[714px]">
              ...
              <div className="absolute top-[581px] left-[1px] rounded-xl bg-gainsboro-100 w-[633px] h-[133px]" />
              <div className="absolute top-[589px] left-[1px] rounded-xl w-[233px] flex flex-row p-2.5 box-border items-start justify-start">
        ...
        <div className="absolute top-[785px] left-[735px] bg-white w-[734px] h-[695px] overflow-hidden">
            ...
            <div className="absolute top-[363px] left-[0px] w-[667px] h-[710px]">
              ...
              <div className="absolute top-[547px] left-[3px] w-[663px] h-[163px]">
                <img
                  ...
                  src="/rectangle-181.svg"
                />
                <div className="absolute top-[72px] left-[21px]">
                  開辦新路線
                </div>
                <div className="absolute top-[103px] left-[20px]">
                  ■ 來往海達邨及深水埗(桂林街)
                ...
                <div className="absolute top-[15px] left-[21px]">
                  26/03/2023
                </div>
                <div className="absolute top-[34px] left-[20px] w-[244px] h-9 text-xl">
                  <div className="absolute top-[8px] left-[204px]">號線</div>
        ...
        <div className="absolute top-[785px] left-[0px] bg-white w-[734px] h-[695px] overflow-hidden text-white">
          <div className="absolute top-[145px] left-[690px] rounded-xl bg-gainsboro-200 w-3 h-[544px]" />
          <div className="absolute top-[147px] left-[690px] rounded-xl bg-gainsboro-100 w-3 h-[97px]" />
      ...
      <div className="absolute top-[18px] left-[18px] w-[1430px] h-[239px] text-5xl text-gray-200">
        ...
        <div className="absolute h-[51.91%] w-[34.55%] top-[7.11%] right-[0%] bottom-[40.98%] left-[65.45%] text-45xl text-black">
          ...
          <div
            className="absolute h-[78.18%] w-[17%] top-[4.03%] right-[32.79%] bottom-[17.79%] left-[50.2%] flex flex-col p-2.5 box-border items-center justify-start cursor-pointer"
            onClick={onFrameContainer23Click}
          >
...
export default MainIndexTraditional;
